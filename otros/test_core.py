...
class MiVentana(QWidget):
    ...
    def _cnf_MiVentana(self):
        ...
        # self.timer.singleShot(5000, self)
    ...
    def _test_video(self):
        ...
        vi1 = "/home/tomy/Vídeos/ARCADEA - Exodus of Gravity (Official Visualizer).mp4"
        self.set_media(vi1)
    ...
    def stop(self):
        ...
        self.control.btn_play.setIcon(QIcon(':/w/play.svg'))
    ...
    def toggle_playback(self):
        if self.core.player.is_playing():
            self.pause()
        else:
            self.play()
    ...
    def play(self):
        self.core.play()
        self.control.btn_play.setIcon(QIcon(':/w/pause.svg'))
        self.show_duration()
