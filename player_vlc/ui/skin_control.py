...
class Ui_Control(object):
    def setupUi(self, Control):
        ...
        icon = QIcon()
        icon.addFile(u":/w/play.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/w/stop.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/w/image.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/w/settings2.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
